...
know = [p1,p2,p3,p4] # 알려진 집단 : 중첩list 
unKnow = [p5] # 알려지지 않은 집단 : 중첩list 


# 3. 분류기 평가
knn = KNeighborsClassifier(n_neighbors=3).fit(X=know, y=y_class)

y_pred = knn.predict(X = unKnow)
y_pred # [1]

print('분류결과 :', class_label[y_pred[0]]) # 분류결과 : B
